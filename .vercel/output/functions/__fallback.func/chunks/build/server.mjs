...
import { defineComponent, computed, h, onServerPrefetch, hasInjectionContext, inject, getCurrentInstance as getCurrentInstance$1, shallowRef, defineAsyncComponent, createElementBlock, provide, cloneVNode, toValue, reactive, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, toRef, getCurrentScope, withCtx, isReadonly, isRef, isShallow, isReactive, toRaw, customRef } from 'vue';
import { y as parseURL, z as encodePath, A as decodePath, B as hasProtocol, C as isScriptProtocol, x as joinURL, w as withQuery, D as klona, E as sanitizeStatusCode, F as defuFn, G as getContext, $ as $fetch$1, H as baseURL, I as hash, J as defu, q as createError$1, K as executeAsync, L as getRequestURL, M as getRequestHeader, N as getCookie, O as parse$1, P as isEqual, Q as createDefu, R as parsePath, p as parseQuery, S as setCookie, T as deleteCookie, U as withoutTrailingSlash } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "projects-id",
    path: "/projects/:id()",
    component: () => import('./_id_-DGYRM942.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CSesN3dn.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-C-d7C14D.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-BCwi7qg_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-CKV96wEc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-Bd9Lxbu0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Av1u78BU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DlNcuZjO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Bs5vcR12.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DQ5pBCkm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DOXQrda4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BTc1khK8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-ClSY4Z4u.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-ClB9BKro.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BChf_jZp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-B2kxecVK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-ufhU_4PD.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-Ci4CPgeb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BiqcLAWI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-3_cfe0rW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-D0UkXYOq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-vm6mK5iH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-Icdt7FAB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DfLIWpsu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BHo3EGPn.mjs').then((r) => r["default"] || r.default || r));
  ...
  id: [
    {
      ...
      load: () => import(
        './id-3z4u2_T5.mjs'
        /* webpackChunkName: "locale_id_46json_9093e057" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-8mRrkB7x.mjs'
        /* webpackChunkName: "locale_en_46json_574d80b4" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/JC_CpThl"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/JC_CpThl"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bqa9_izZ.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#0b1120] text-slate-300 overflow-x-hidden flex flex-col font-sans" }, _attrs))}>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative bg-space-900 text-white w-full min-h-screen flex flex-col items-center justify-center overflow-hidden font-sans" }, _attrs))} data-v-ce95266d><div class="absolute top-[10%] left-[-10%] w-[500px] h-[500px] bg-neon-purple/20 blur-[120px] rounded-full pointer-events-none" data-v-ce95266d></div><div class="absolute bottom-[10%] right-[-10%] w-[600px] h-[600px] bg-neon-cyan/20 blur-[150px] rounded-full pointer-events-none" data-v-ce95266d></div><div class="relative z-10 w-full px-6 flex flex-col items-center" data-v-ce95266d><div class="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center mb-8 drop-shadow-[0_0_30px_rgba(34,211,238,0.2)]" data-v-ce95266d><svg class="absolute inset-0 w-full h-full ring-spin-slow origin-center" viewBox="0 0 200 200" data-v-ce95266d><circle cx="100" cy="100" r="95" fill="none" stroke="#A855F7" stroke-width="1" stroke-dasharray="4 8" opacity="0.4" data-v-ce95266d></circle><circle cx="100" cy="100" r="85" fill="none" stroke="#22D3EE" stroke-width="2" stroke-dasharray="40 20 10 20" opacity="0.6" data-v-ce95266d></circle></svg><svg class="absolute inset-0 w-full h-full ring-spin-reverse origin-center" viewBox="0 0 200 200" data-v-ce95266d><circle cx="100" cy="100" r="70" fill="none" stroke="#A855F7" stroke-width="3" stroke-dasharray="50 30" opacity="0.8" data-v-ce95266d></circle><circle cx="100" cy="100" r="60" fill="none" stroke="#ffffff" stroke-width="1" stroke-dasharray="2 6" opacity="0.3" data-v-ce95266d></circle></svg><svg class="absolute inset-0 w-full h-full ring-pulse origin-center" viewBox="0 0 200 200" data-v-ce95266d><circle cx="100" cy="100" r="45" fill="none" stroke="#22D3EE" stroke-width="1" stroke-dasharray="10 10" opacity="0.5" data-v-ce95266d></circle></svg><h1 class="relative z-10 text-6xl md:text-7xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-b from-white via-neon-cyan to-neon-purple drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]" data-v-ce95266d> 404 </h1></div><div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl px-8 py-8 md:py-10 mb-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] max-w-lg mx-auto relative group floating-card" data-v-ce95266d><div class="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 h-[2px] bg-gradient-to-r from-transparent via-neon-cyan to-transparent opacity-70" data-v-ce95266d></div><h2 class="text-2xl md:text-3xl font-display font-semibold mb-4 text-white flex items-center justify-center gap-3" data-v-ce95266d><div class="w-3 h-3 rounded-full bg-red-500 animate-pulse shadow-[0_0_10px_rgba(239,68,68,0.8)]" data-v-ce95266d></div> Target Tidak <span class="text-neon-cyan" data-v-ce95266d>Ditemukan</span></h2><p class="text-slate-400 font-mono text-sm leading-relaxed text-center" data-v-ce95266d> [ STATUS KODE: <span class="text-neon-purple" data-v-ce95266d>${ssrInterpolate(__props.error?.statusCode || "404")}</span> ] <br data-v-ce95266d><br data-v-ce95266d> Sektor URL yang Anda masuki belum dipetakan atau sedang dalam konstruksi. Menginisiasi protokol penarikan otomatis ke sektor aman. </p></div><button class="relative overflow-hidden flex items-center gap-3 px-8 py-4 rounded-full bg-neon-cyan/10 border border-neon-cyan/50 text-neon-cyan font-mono font-semibold hover:bg-neon-cyan hover:text-space-900 transition-all duration-300 shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:shadow-[0_0_30px_rgba(34,211,238,0.6)] hover:-translate-y-1 group" data-v-ce95266d><span class="relative z-10 flex items-center gap-2" data-v-ce95266d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "uil:rocket",
        class: "text-xl group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform duration-300"
      }, null, _parent));
      _push(` Evakuasi Manual (${ssrInterpolate(countdown.value)}s) </span><div class="absolute left-0 bottom-0 top-0 bg-neon-cyan/20 transition-all ease-linear" style="${ssrRenderStyle({
        width: `${countdown.value / 10 * 100}%`,
        transitionDuration: "1s"
      })}" data-v-ce95266d></div></button></div></div>`);
    };
  }
});
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ce95266d"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { __nuxt_component_0 as _, useSeoMeta as a, _export_sfc as b, useHead as c, useRouter as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, useRuntimeConfig as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, useI18n as u };
