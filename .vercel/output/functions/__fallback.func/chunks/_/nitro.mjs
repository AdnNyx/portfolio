...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "3b62f57d-39fb-4e42-9d24-1e2a54614a93",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "D:/Web_Develop/Portfolio/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
var footer$1 = {
	copyright: "© 2026 Mahfudin Adnan. Hak cipta dilindungi undang-undang.",
	terms: "Syarat & Ketentuan",
	privacy: "Kebijakan Privasi"
};
var home$1 = {
	greeting: "Halo, Saya",
	role_prefix: "Dan saya seorang",
	description: "Saya adalah seorang pengembang perangkat lunak yang antusias dalam membangun aplikasi web modern, fungsional, dan ramah pengguna.",
	more_about: "Lebih Banyak Tentang Saya",
	download_cv: "Unduh CV"
};
var about$1 = {
	title_1: "Tentang",
	title_2: "Saya",
	p1: "Halo! Saya adalah Mahfudin Adnan, seorang Software Engineer yang berfokus pada pengembangan ekosistem digital yang modern dan intuitif. Bagi saya, 'coding' bukan sekadar menulis baris perintah, melainkan seni merancang solusi nyata yang memudahkan penggunanya.",
	p2: "Dengan pengalaman dalam merancang antarmuka untuk aplikasi berskala institusi, hingga merakit integrasi 'AI Chatbot', saya selalu antusias menghadapi tantangan teknis yang baru. Saya percaya bahwa perpaduan antara visual yang indah dan arsitektur sistem yang tangguh adalah kunci dari produk digital yang sukses.",
	cta: "Lihat Keahlian Saya"
};
var services$1 = {
	title_1: "Keahlian &",
	title_2: "Layanan",
	dev_title: "Pengembangan Web & Mobile",
	dev_desc: "Merancang arsitektur aplikasi fullstack yang tangguh dan antarmuka lintas platform yang responsif menggunakan Vue.js, Flutter, FastAPI, dan Golang.",
	ai_title: "AI & Solusi Cerdas",
	ai_desc: "Mengintegrasikan kecerdasan buatan dan Large Language Models (LLM) untuk menciptakan ekosistem Chatbot yang cerdas dan otomatisasi pintar.",
	blockchain_title: "Integrasi Web3 & Blockchain",
	blockchain_desc: "Mengeksplorasi teknologi desentralisasi, mengembangkan fondasi smart contract, serta mengintegrasikan kapabilitas Web3 ke dalam aplikasi modern."
};
var portfolio$1 = {
	title_port_1: "Karya",
	title_port_2: "Unggulan",
	project1_title: "Profil Perusahaan Satyavrata",
	project1_desc: "Website profil perusahaan ekspor yang menampilkan produk berkualitas dari Indonesia untuk pasar Timur Tengah dan Asia, menekankan rantai pasok yang konsisten dan berkelanjutan.",
	project2_title: "Platform Membaca Novel",
	project2_desc: "Ekosistem membaca yang dibangun dengan Next.js dan didukung oleh infrastruktur backend Python dan PostgreSQL yang tangguh, memberikan pengalaman yang mulus bagi para penggemar novel.",
	project3_title: "EduPortal MI Al-Hidayah",
	project3_desc: "Sistem informasi sekolah resmi yang dilengkapi modul administrasi yang aman, proteksi rute modern, dan portal publik untuk manajemen pendidikan yang efisien.",
	project4_title: "Portofolio Personal Interaktif",
	project4_desc: "Website portofolio modern yang sangat interaktif, menampilkan animasi GSAP, elemen 3D, dan dukungan multibahasa penuh untuk memamerkan keahlian pengembangan saya.",
	project5_title: "Generator Kode QR",
	project5_desc: "Utilitas web yang cepat dan andal untuk menghasilkan kode QR kustom secara instan, dirancang untuk berbagai kebutuhan digital dan cetak.",
	project6_title: "Pengunduh Video Universal",
	project6_desc: "Aplikasi utilitas tangguh yang dikembangkan menggunakan Python dan Flask untuk mengekstrak dan mengunduh konten media dari berbagai platform video online dengan mudah.",
	project7_title: "Aplikasi Streaming Anime",
	project7_desc: "Platform streaming dinamis yang memanfaatkan REST API pihak ketiga untuk mengambil, mencari, dan memutar episode terbaru dengan lancar tanpa hambatan.",
	project8_title: "Penghapus Latar Belakang AI",
	project8_desc: "Alat pemrosesan gambar berbasis AI yang secara akurat memisahkan dan menghapus subjek dari latar belakang aslinya hanya dalam hitungan detik."
};
var contact$1 = {
	heading_1: "Mulai",
	heading_2: "Koneksi",
	subheading: "// Buat Jalur Komunikasi Terenkripsi",
	form: {
		name_label: "Identitas",
		email_label: "Surel",
		subject_label: "Subjek",
		message_label: "Pesan",
		submit: "Kirim Sinyal",
		submitting: "Mengirim...",
		success: "Transmisi Berhasil. Saya akan segera merespon.",
		error: "Koneksi Gagal. Silakan coba lagi."
	},
	info: {
		title: "Pusat Operasi.",
		desc: "Berpusat di Tegal, Jawa Tengah. Saya selalu terbuka untuk diskusi mengenai arsitektur perangkat lunak, kolaborasi jarak jauh, atau sekadar bertukar pikiran.",
		socials: "// Transmisi Alternatif"
	}
};
const locale_id_46json_9093e057 = {
	nav: nav$1,
	footer: footer$1,
	home: home$1,
	about: about$1,
...
var footer = {
	copyright: "© 2026 Mahfudin Adnan. All rights reserved.",
	terms: "Terms & Conditions",
	privacy: "Privacy Policy"
};
var home = {
	greeting: "Hello, It's Me",
	role_prefix: "And I'm a",
	description: "I am an enthusiastic software developer dedicated to building modern, functional, and user-friendly web applications.",
...
var about = {
	title_1: "About",
	title_2: "Me",
	p1: "Hello! I'm Mahfudin Adnan, a Software Engineer focused on developing modern and intuitive digital ecosystems. For me, 'coding' is not just about writing lines of commands, but the art of designing real-world solutions that make users' lives easier.",
	p2: "With experience in designing interfaces for institutional-scale applications, to assembling 'AI Chatbot' integrations, I am always enthusiastic about tackling new technical challenges. I believe that the combination of beautiful visuals and robust system architecture is the key to a successful digital product.",
	cta: "See My Expertise"
};
var services = {
	title_1: "Expertise &",
	title_2: "Services",
	dev_title: "Web & Mobile Development",
	dev_desc: "Architecting scalable fullstack applications and responsive cross-platform interfaces using Vue.js, Flutter, FastAPI, and Golang.",
	ai_title: "AI & Smart Solutions",
	ai_desc: "Integrating artificial intelligence and Large Language Models (LLM) to build intelligent Chatbot ecosystems and smart automations.",
	blockchain_title: "Web3 & Blockchain Integration",
	blockchain_desc: "Exploring decentralized technologies, developing foundational smart contracts, and integrating Web3 capabilities into modern apps."
};
var portfolio = {
	title_port_1: "Featured",
	title_port_2: "Works",
	project1_title: "Satyavrata Company Profile",
	project1_desc: "A premier trading company profile showcasing high-quality Indonesian export products to global markets in the Middle East and Asia, emphasizing scalable and sustainable supply chains.",
	project2_title: "Novel Platform",
	project2_desc: "A robust reading ecosystem built with Next.js and backed by a highly performant Python and PostgreSQL infrastructure, delivering a seamless experience for novel enthusiasts.",
	project3_title: "EduPortal MI Al-Hidayah",
	project3_desc: "An official school information system featuring secure administrative modules, modern router guards, and a public-facing portal for streamlined educational management.",
	project4_title: "Interactive Personal Portfolio",
	project4_desc: "A highly interactive and modern web portfolio featuring GSAP animations, 3D elements, and full internationalization to showcase my engineering capabilities.",
	project5_title: "QR Code Generator",
	project5_desc: "A fast and reliable web utility for generating custom QR codes instantly, designed for a variety of digital and print use cases.",
	project6_title: "Universal Video Downloader",
	project6_desc: "A powerful utility built with Python and Flask to effortlessly extract and download media content from multiple online video platforms.",
	project7_title: "Anime Streaming App",
	project7_desc: "A dynamic streaming platform utilizing third-party REST APIs to fetch, search, and stream the latest episodes seamlessly.",
	project8_title: "AI Background Remover",
	project8_desc: "An AI-powered image processing tool that accurately removes and isolates subjects from their backgrounds in a matter of seconds."
};
var contact = {
	heading_1: "Initiate",
	...
	form: {
		...
		success: "Signal Delivered. I will respond shortly.",
		error: "Connection Failed. Please try again."
	},
	info: {
		title: "Base of Operations.",
		desc: "Based in Tegal, Central Java. Open for discussions on software architecture, remote collaborations, or just exchanging ideas.",
		socials: "Alt Channels"
	}
};
const locale_en_46json_574d80b4 = {
	nav: nav,
	footer: footer,
	home: home,
	about: about,
...
const localeLoaders = {
  id: [
    {
      key: "locale_id_46json_9093e057",
      load: () => Promise.resolve(locale_id_46json_9093e057),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_574d80b4",
      load: () => Promise.resolve(locale_en_46json_574d80b4),
      cache: true
    }
  ]
};
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#22d3ee"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s | Mahfudin Adnan"};
...
const _BeXg0fR5FIH4lzDSp0gIdDKSffbzSjL6e2_niQ68k9s = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/JC_CpThl") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _BeXg0fR5FIH4lzDSp0gIdDKSffbzSjL6e2_niQ68k9s
];
...
const collections = {
  'uil': () => import('./icons.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _CjYtvN = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _87l58W = eventHandler(async (event) => {
...
const _uGcxS8 = _messagesHandlerCached;
...
const _kU31CB = eventHandler(async (event) => {
...
const _lazy_hCaEVc = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_hCaEVc, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _CjYtvN, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _87l58W, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _87l58W, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _uGcxS8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _kU31CB, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _kU31CB, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hCaEVc, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, decodePath as A, hasProtocol as B, isScriptProtocol as C, klona as D, sanitizeStatusCode as E, defuFn as F, getContext as G, baseURL as H, hash$1 as I, defu as J, executeAsync as K, getRequestURL as L, getRequestHeader as M, getCookie as N, parse as O, isEqual as P, createDefu as Q, parsePath as R, setCookie as S, deleteCookie as T, withoutTrailingSlash as U, withTrailingSlash as V, withLeadingSlash as W, appRootTag as a, appRootAttrs as b, buildAssetsURL as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, appId as j, defineRenderHandler as k, publicAssetsURL as l, appTeleportTag as m, appTeleportAttrs as n, getQuery as o, parseQuery as p, createError$1 as q, appHead as r, destr as s, toNodeListener as t, useNitroApp as u, getRouteRules as v, withQuery as w, joinURL as x, parseURL as y, encodePath as z };
